            ...
            <div x-show="sidebar" x-cloak class="fixed inset-0 z-50 lg:relative lg:z-auto">
                ...
                <aside class="relative w-64 h-full bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 overflow-y-auto">
                    ...
                    <nav class="p-4 space-y-1">
                        ...
                        <a href="{{ route('admin.payouts.index') }}" class="flex items-center gap-3 px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('admin.payouts*') ? 'bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 font-medium' : 'text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800' }}">
